...
<p align="left">
  ...
  <br/><br/>
  <strong>Current Focus:</strong> Blockchain Virtual Asset Tax Accounting | Journal Entry Systems | Backend Development | Financial Data Processing
  <br/>
  <strong>Expertise:</strong> Web Application Development | Backend Systems | Blockchain Solutions | Financial Technology
  <br/>
  <strong>Innovation:</strong> Multiple hackathon winner with proven track record in delivering cutting-edge fintech solutions
  <br/>
  <strong>Learning:</strong> Continuously exploring emerging technologies in DeFi, Tax Technology, and Blockchain Compliance
  <br/><br/>
